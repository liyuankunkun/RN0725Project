...
class IntlFlightCellView extends React.Component {
    static propTypes = {
                ...
                <View style={{ backgroundColor: Theme.greenBg, borderRadius: 4, paddingHorizontal: 10 }}>
                    <View style={{ flexDirection: 'row', justifyContent: 'space-between', alignItems: 'center' }}>
                        ...
                        <View style={{ alignItems: 'center', padding: 10 }}>
                            <CustomText text={diffDay} style={{ fontSize: 12, color: 'gray' }} />
                    ...
                    <View style={{ flexDirection: 'row', marginVertical: 5 }}>
                        <CustomText text={item.Carrier} style={{ fontSize: 11, marginLeft: 10, color: 'gray' }} />
                        <CustomText text={item.Seat} style={{ fontSize: 11, marginHorizontal: 4, color: 'gray' }} />
                        <CustomText text={item.Equipment} style={{ fontSize: 11, marginHorizontal: 4, color: 'gray' }} />
                    </View>
                    <TouchableOpacity style={{ borderTopWidth: 1, borderColor: Theme.normalBg, marginLeft: 5, paddingVertical: 15, marginTop: 10, flexDirection: Util.Parse.isChinese ? 'row' : 'column', alignItems: 'center', justifyContent: 'space-between' }}
...
export default function(props) {
    ...
    return <IntlFlightCellView {...props} navigation={navigation} />;
}
