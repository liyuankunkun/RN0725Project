...
class FlightCardScreen extends SuperView {
    constructor(props) {
        super(props);
        ...
        this.state = {
            dataList: this.params.CardTravellerList,
        }
    }
            ...
            <TouchableHighlight underlayColor='transparent'>
                <View style={styles.row} >
                    <View style={{  justifyContent: "center", flex: 1 }}>
                        <CustomText text={item.AirPortName} />
...
export default connect(getStateProps)(FlightCardScreen);
